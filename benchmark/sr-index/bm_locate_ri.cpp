...
auto BM_PrintQueryLocate = [](
    benchmark::State &t_state, const auto &t_idx_name, auto t_factory, auto t_config, const auto &t_patterns) {
    ...
    try {
      ...
      if (FLAGS_print_result) {
        ...
        benchmark::RegisterBenchmark(
            print_bm_name.c_str(), BM_PrintQueryLocate, idx_config.first, factory, idx_config.second, patterns);
      }
    }
